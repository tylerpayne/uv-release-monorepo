...
class TestDev0Baseline:
    ...
    def test_uses_baseline_tag(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
    ) -> None:
        _workspace_with_version(
            tmp_path,
            monkeypatch,
            "1.0.0.dev0",
            [
    ...
    def test_falls_back_to_previous_release(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
    ) -> None:
        ws = _workspace_with_version(
            tmp_path,
            monkeypatch,
            "1.0.0.dev0",
            [
...
class TestCleanBaseline:
    ...
    def test_clean_stable_uses_previous_release(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
    ...
    def test_clean_pre_uses_previous_release(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
...
class TestPostBaseline:
    ...
    def test_post_diffs_against_stable(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
...
class TestNoBaseline:
    ...
    def test_no_tags_is_initial_release(
        self,
        tmp_path: Path,
        monkeypatch: pytest.MonkeyPatch,
        capsys: pytest.CaptureFixture[str],
